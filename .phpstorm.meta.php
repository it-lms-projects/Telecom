...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\bmbuyi\Documents\Web Projects\QuickGmao\public\storage' => 'string',
...
'filesystems.links.C:\\Users\\bmbuyi\\Documents\\Web Projects\\QuickGmao\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.microsoft.client_id','services.microsoft.client_secret',
'services.microsoft.redirect','services.microsoft.proxy','session.driver','session.lifetime','session.expire_on_close',
...
'session.http_only','session.same_site','session.partitioned','snappy.pdf.enabled','snappy.pdf.binary',
'snappy.pdf.timeout','snappy.pdf.options','snappy.pdf.env','snappy.image.enabled','snappy.image.binary',
'snappy.image.timeout','snappy.image.options','snappy.image.env','broadcasting.default','broadcasting.connections.reverb.driver',
...
'sanctum.csrf-cookie','signin','signup','signout','microsoft.login','storage.local',);
        registerArgumentsSet('views', 
'index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'DB_USERNAME','DB_PASSWORD','DB_CHARSET','DB_COLLATION','SESSION_DRIVER',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','MICROSOFT_CLIENT_ID','MICROSOFT_CLIENT_SECRET','MICROSOFT_REDIRECT_URI',
'MICROSOFT_TENANT_ID','VITE_APP_NAME',);
